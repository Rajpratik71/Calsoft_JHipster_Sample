...
import com.calsoftinc.jhipstersample.config.KafkaProperties;
...
class CalsoftJHipsterSampleKafkaResourceIT {
    ...
    void setup() {
        ...
        CalsoftJHipsterSampleKafkaResource kafkaResource = new CalsoftJHipsterSampleKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/calsoft-j-hipster-sample-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/calsoft-j-hipster-sample-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
