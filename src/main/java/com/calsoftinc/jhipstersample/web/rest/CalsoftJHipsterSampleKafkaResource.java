...
@RestController
@RequestMapping("/api/calsoft-j-hipster-sample-kafka")
public class CalsoftJHipsterSampleKafkaResource {
    private final Logger log = LoggerFactory.getLogger(CalsoftJHipsterSampleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CalsoftJHipsterSampleKafkaResource(KafkaProperties kafkaProperties) {
